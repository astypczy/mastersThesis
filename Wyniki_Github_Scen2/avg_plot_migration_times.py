...
plt.title('Scenario 2.: Average Migration Time by Context')
plt.xticks(x)
plt.legend()
plt.tight_layout()
plt.show()
...
plt.title('Scenario 2.: Average Rollback Time by Context')
plt.xticks(x)
plt.legend()
plt.tight_layout()
plt.show()
...
plt.title('Scenario 2.: Average Success Rate by Context')
plt.xticks(x)
plt.legend()
plt.tight_layout()
plt.show()
