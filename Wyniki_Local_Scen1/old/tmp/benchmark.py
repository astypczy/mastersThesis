...
TOOLS = {
    "Flyway": {
        "scenario_endpoint": "/run-tests/Flyway/scenario1",
        "context_endpoint": "/run-tests/Flyway/",
        "rollback_endpoint": "/run-tests/Flyway/rollback/",
        "contexts": [str(i) for i in range(1, 14)]
    },
    "Liquibase": {
        "scenario_endpoint": "/run-tests/Liquibase/scenario1",
...
def main():
    print("Scen1 benchmark: " + str(NUM_RUNS) +" loops")
